local gui = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/EKanyzu/scripts/main/bypass.lua"))():AddWindow("Ro-Ghoul", {
...
local myData = loadstring(game:HttpGet("https://raw.githubusercontent.com/EKanyzu/scripts/main/Set.lua"))()("Ro-Ghoul Autofarm", {
    Skills = {
        E = false,
        F = false,
        C = false,
